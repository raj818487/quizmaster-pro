...
if (fs.existsSync(newDbPath)) {
  console.log(
    "Warning: New database file already exists. Migration will be skipped."
  );
  console.log(
    "If you want to force migration, please delete the backend/quizmaster.db file first."
  );
  process.exit(0);
}
